      ...
      <div className="pt-8 px-4">
        <div className="container-custom">
          ...
          <div className="flex flex-wrap items-center gap-6 text-lg bg-white/90 backdrop-blur-lg border border-slate-200 rounded-lg p-4 shadow-sm">
            <Link href="/research/school-innovation" className="text-blue-700 font-bold hover:text-blue-800 transition-colors">
              학교 혁신
            </Link>
            <span className="text-slate-300">|</span>
            <Link href="/research/academic-research" className="text-slate-700 hover:text-blue-600 transition-colors font-medium">
              연구 활동
            </Link>
            <span className="text-slate-300">|</span>
